...
public class TestApplication {
    ...
    public static void main(String[] args) {
        ...
        employeService.create(new Employe("EMP001", "Mohamed", "hmd", "Mohamed@example.com",
                "0612345678", "Casablanca", "15/03/1985"));
        employeService.create(new Employe("EMP002", "Ben", "haada", "haada.Ben@example.com",
                "0612345679", "Rabat", "20/05/1990"));
        employeService.create(new Employe("EMP003", "ss", "aa", "aa@example.com",
